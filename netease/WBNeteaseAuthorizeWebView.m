...
@interface WBNeteaseAuthorizeWebView (Private)
...
@implementation WBNeteaseAuthorizeWebView
...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 20, 320, 460)])
    {
        ...
        // add the panel view
        panelView = [[UIView alloc] initWithFrame:CGRectMake(5, 35, 310, 430)];
        ...
        containerView = [[UIView alloc] initWithFrame:CGRectMake(5, 5, 310, 450)];
        ...
        // add the web view
        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 300, 415)];
        ...
        [indicatorView setCenter:CGPointMake(320/2.0f, 460/2.0f)];
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    if (UIInterfaceOrientationIsLandscape(orientation))
    {
        ...
        [panelView setFrame:CGRectMake(5, 15, 470, 290)];
        [containerView setFrame:CGRectMake(5, 5, 470, 310)];
        [webView setFrame:CGRectMake(0, 0, 460, 290)];
        [indicatorView setCenter:CGPointMake(480/2.0f, 320/2.0f)];
    }
    else
    {
        [self setFrame:CGRectMake(0, 20, 320, 460)];
        [panelView setFrame:CGRectMake(5, 35, 310, 430)];
        [containerView setFrame:CGRectMake(5, 5, 310, 450)];
        [webView setFrame:CGRectMake(0, 0, 300, 415)];
        [indicatorView setCenter:CGPointMake(320/2.0f, 460/2.0f)];
    }
    
    [self setCenter:CGPointMake(320/2.0f, 460/2.0f)];
...
{
    if ([request.URL.absoluteString rangeOfString:@"oauth_callback=oob&authorize=1"].location != NSNotFound) {
        if ([delegate respondsToSelector:@selector(authorizeWebView:didReceiveAuthorizeCode:)])
        {
            [delegate authorizeWebView:self didReceiveAuthorizeCode:@"200"];
        }
    }
    return YES;
}
